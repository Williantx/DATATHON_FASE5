...
if pagina == "📋 Apresentação":
    ...
    <div class="pm-presentation-wrapper">
        <iframe
            src="https://gamma.app/docs/Passos-Magicos-Dados-que-Transformam-Vidas-a7txgnxyhampsvg"
            allow="fullscreen"
            allowfullscreen
    ...
    <div style="margin-top:16px; display:flex; gap:12px; align-items:center; flex-wrap:wrap;">
        <a class="pm-fs-btn"
           href="https://gamma.app/docs/Passos-Magicos-Dados-que-Transformam-Vidas-a7txgnxyhampsvg"
