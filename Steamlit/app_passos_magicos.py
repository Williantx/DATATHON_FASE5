...
with tab2:
    ...
    st.subheader("🖥️ Apresentação do Projeto")

    st.markdown("""
    Visualização da apresentação oficial do projeto.
    """)
    ...
    st.markdown(
        ...
        <div class="pm-presentation-wrapper">
            <iframe
                src="https://gamma.app/embed/x3mizal8izkj49u"
                allow="fullscreen"
                loading="lazy">
            </iframe>
        </div>
        ...
        <a
            href="https://gamma.app/embed/x3mizal8izkj49u"
            target="_blank"
            class="pm-fs-btn">
            ⛶ Abrir em Fullscreen
        </a>
